 ...
 *
 * One view: case background on top (read as text — NOT voiced), the clauses to
 * choose from below. Each clause card expands to reveal the fine print; a
 * checkbox chooses which to defend. The voice round only begins after this step.
 */
...
export function ContextClauses({
  ...
  return (
    <section className="flex flex-col gap-5">
      {/* Case background — plain text, read before the round (no voice here) */}
      ...
      {/* Clauses — choose which to defend; click a card to expand the fine print */}
      <div>
        <h3 className="text-sm font-medium text-[--color-text-secondary]">
          The clauses in play — pick the ones you&apos;ll defend
        </h3>
